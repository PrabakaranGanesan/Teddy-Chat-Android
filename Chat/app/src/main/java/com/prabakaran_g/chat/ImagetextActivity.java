...
public class ImagetextActivity extends AppCompatActivity {
    ...
    private Toolbar imagetexttoolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagetexttoolbar = (Toolbar)findViewById(R.id.imagetext_toolbar);
        setSupportActionBar(imagetexttoolbar);
        getSupportActionBar().setTitle("Image To Text Converter");
